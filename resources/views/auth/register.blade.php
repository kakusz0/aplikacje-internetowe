...
<div class="min-h-screen flex items-center justify-center bg-gradient-to-tr from-violet-200 to-fuchsia-100 py-8">
    <div class="max-w-md w-full bg-white rounded-xl shadow-lg p-8 animate__animated animate__fadeInUp">
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-6">
            ...
            <div>
                <label for="last_name" class="block mb-1 font-medium text-gray-700">Imię</label>
            ...
            <button type="submit"
                    class="w-full bg-violet-700 text-white font-bold py-2 rounded-lg hover:bg-violet-800 transition">Zarejestruj się</button>
        </form>
